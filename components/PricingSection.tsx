      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pricing-cards">
          <div className="pricing-card" id="weekday-card">
            ...
            <button className="btn btn-outline">Купити квиток</button>
          </div>
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-2xl relative ">
              ...
              <button className="bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-8 rounded-lg mb-4 transition-colors duration-300 shadow-lg mx-5">
